...
var loader = function loader() {__webpack_require__.e(/*! require.ensure | element/loading */ "element/loading").then((function () {return resolve(__webpack_require__(/*! ./element/loading.vue */ 69));}).bind(null, __webpack_require__)).catch(__webpack_require__.oe);};_vue.default.component('load-list', loader); // 引入没有数据的提示
var nonedata = function nonedata() {__webpack_require__.e(/*! require.ensure | element/none */ "element/none").then((function () {return resolve(__webpack_require__(/*! ./element/none.vue */ 76));}).bind(null, __webpack_require__)).catch(__webpack_require__.oe);};_vue.default.component('none-data', nonedata); // 进入页面的loading加载
var homeload = function homeload() {__webpack_require__.e(/*! require.ensure | element/homeload */ "element/homeload").then((function () {return resolve(__webpack_require__(/*! ./element/homeload.vue */ 83));}).bind(null, __webpack_require__)).catch(__webpack_require__.oe);};_vue.default.component('home-load', homeload); // 引入css3动画插件
